...
class JDownloaderHelper:
    ...
    async def wait_for_configurations(self):
        buttons = ButtonMaker()
        buttons.url_button("Select", "https://my.jdownloader.org", style="primary")
        buttons.data_button("Done Selecting", "jdq sdone", style="success")
        buttons.data_button("Cancel", "jdq cancel", style="danger")
